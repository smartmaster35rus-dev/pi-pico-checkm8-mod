...
- [Visual Studio Code](https://code.visualstudio.com/) с неисследованиеимыми расширениями.
...
1. **Подключите устройство Apple A5**:
   ...
   - При неисследованиеимости — соедините контакты GPIO по схеме (см. [Схема подключения](#схема-подключения)).
...
**Внимание**: Неисследованиеима точность подключения!  
...
**Платформа полностью работает через штатные USB-разъёмы. При неисследованиеимости подключения GPIO — смотрите отдельную схему:**
